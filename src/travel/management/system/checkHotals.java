...
public class checkHotals extends JFrame implements Runnable{
    ...
    @Override
    public void run() {
        String[] text=new String []{"JW Marriott Hotel","Madrian Oriental Hotel","Four Seasons Hotel","Raddisson Blue Hotel","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Moorning Motel","River Point Hotel","Snow Point Htel"};
        try{
            for(int i=0;i<=9;i++){
