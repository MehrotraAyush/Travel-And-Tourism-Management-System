...
public class ViewBookedHotel extends JFrame implements ActionListener{
    JLabel labelusername,labelhotel,labelpersons,labeldays,labelac,labelfood,labelid,labelnumber,labelphone,labelprice;
    JButton back;
    ...
    ViewBookedHotel(String username){
       ...
       add(labelprice);
        ...
        image.setBounds(450, 50, 500, 450);
        add(image);
    ...
    public static void main(String[] args) {
        new ViewBookedHotel("Ayush Mehrotra");
    }
